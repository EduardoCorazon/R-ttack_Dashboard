...
import {columns, users, statusOptions} from "./reference-guide-data";
...
const INITIAL_VISIBLE_COLUMNS = ["name", "frequency", "actions"];
            ...
            case "frequency":
                return (
                    <div className="flex flex-col">
                        <p className="text-bold text-small capitalize">{cellValue} Mhz</p>
                    </div>
                );
                ...
                return (
                    <div className="relative flex justify-end items-center gap-2">
                        <Dropdown>
                            ...
                            <DropdownMenu>
                                <DropdownItem href="/ReferenceGuide">View</DropdownItem>
                                    ...
                                    <div className="px-1 py-2 w-full">
                                        ...
                                        <div className="mt-2 flex flex-col gap-2 w-full">
                                            ...
                                            <Input
                                                ...
                                                variant="bordered"
                                            />
                                            <Button color="primary" onPress={handleAddDeviceReference}>Add</Button>
                                        </div>
                                    </div>
                                )}
                            </PopoverContent>
